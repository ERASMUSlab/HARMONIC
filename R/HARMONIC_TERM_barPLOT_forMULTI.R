...
#'
#' Draw a bar plot of GO terms within a selected HARMONIC tree for multi-case results.
...
HARMONIC_TERM_barPLOT_forMULTI = function(filepath,
                                       DEG_list_name,
                                       status,
                                       trends,
                                       LABEL,
...
DEG_list_path = paste0(filepath,"/",DEG_list_name)
    ...
    SEPERATE_INPUT = utils::read.table(HARMONIC_SEPERATE_INPUT, sep="\t", header=T, fill=TRUE)
...
DEG_list_path = paste0(filepath,"/",DEG_list_name)
    ...
    HARMONIC_SEPERATE_INPUT = HARMONIC_SEPERATE_forMULTI_range_path
    SEPERATE_INPUT = utils::read.table(HARMONIC_SEPERATE_INPUT, sep="\t", header=T, fill=TRUE)
    SEPERATE_INPUT = stats::na.omit(SEPERATE_INPUT)
